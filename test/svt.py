...
class SpectrogramImage(object):
    def __init__(self, image_width, image_height, fft_size, f_max, f_min, nyquist_freq, palette, logspec):
        ...
        for y in range(self.image_height):
            ...
            #uses the nyquist frequency to allow files of different sampling ratebin = freq / nyquist_freq * (self.fft_size/2 + 1)
...
if __name__ == '__main__':
    processWav("/Users/hehehehehe/Desktop/workspace/576Final/10kHz_44100Hz_16bit_05sec.wav",1)
